...
% Personal data
\name{Programming Advocate}{Grant Smith}
...
\cventry{2021--Present}{\href{https://www.edx.org/boot-camps/data-analytics?linked_from=sitenav}{Data Analytics Boot Camp Instructor}}{EdX / Ohio State University}{Virtual}{}{Taught an online data analytics boot camp.%
    \begin{itemize}%
        \item Earned a 5 star rating from each student -- in both
        ...
        \item Exercised autonomy and course design expertise to
...
\cventry{2022--Present}{Quantitative Developer}{\href{https://www.securitybenefit.com/splash-page}{Security Benefit}}{Topeka}{KS}{Worked on our derivative valuation software.
    \begin{itemize}
        ...
        \item Has given many presentations on topics such as
        Git, deep learning, static sites for documentation.
        \item Performed as mentor and onboarding guide for new hires.
    \end{itemize}
}
\cventry{2020--2021}{
    Business Intelligence Developer}{
        \href{https://www.bv.com}{Black and Veatch}}{
            Overland Park}{KS}{
                ...
                and other BI and data engineering tools.  Was the onboarding
...
\section{Skills}
\cvitem{Technical}{Python, Pandas, Tensorflow, SQL, JavaScript, \LaTeX, Git, Power BI, AWS, Jupyter, Excel, Julia}
\cvitem{Content}{OBS, Reveal.js, YouTube, Medium, GeoGebra}
\cvitem{Soft Skills}{Presenting, curruculum design, teaching, mentoring, onboarding, training, leadership, documentation, communication, teamwork, creativity, innovation}
